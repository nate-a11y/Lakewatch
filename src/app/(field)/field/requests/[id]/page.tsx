...
type RequestStatus = 'assigned' | 'in_progress' | 'completed'
...
export default function ServiceRequestDetailPage() {
  ...
  const [request, setRequest] = useState({
    ...
    notes: 'Customer noted leaves clogging downspouts on north side. Access through the side gate - code is 1234.',

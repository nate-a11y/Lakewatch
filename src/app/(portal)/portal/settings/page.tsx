...
export default function SettingsPage() {
  ...
  const [sessions, setSessions] = useState<Session[]>([
    { id: '1', device: 'MacBook Pro - Chrome', location: 'Kansas City, MO', lastActive: 'Now', isCurrent: true },
    { id: '2', device: 'iPhone 15 Pro - Safari', location: 'Lake Ozark, MO', lastActive: '2 hours ago', isCurrent: false },
  ])

  const [authorizedUsers, setAuthorizedUsers] = useState<AuthorizedUser[]>([
    { id: '1', name: 'Jane Doe', email: 'jane@example.com', role: 'full' },
  ])
          ...
          <div className="bg-[#0f0f0f] border border-[#27272a] rounded-xl p-6">
            ...
            <div className="flex items-center gap-6 mb-8 pb-6 border-b border-[#27272a]">
              ...
              <div>
                ...
                <p className="text-sm text-[#71717a]">Customer since January 2024</p>
              </div>
            </div>
          ...
          <div className="bg-[#0f0f0f] border border-[#27272a] rounded-xl p-6">
            ...
            <div className="space-y-3">
              {authorizedUsers.map((user) => (
                <div key={user.id} className="flex items-center justify-between p-4 bg-black/30 rounded-lg border border-[#27272a]">
                  ...
                  <div className="flex items-center gap-3">
                    <span className={`text-xs px-2 py-1 rounded ${
                      user.role === 'full' ? 'bg-[#4cbb17]/10 text-[#4cbb17]' : 'bg-blue-500/10 text-blue-400'
                    }`}>
                      {user.role === 'full' ? 'Full Access' : 'View Only'}
                    </span>
                    <button
